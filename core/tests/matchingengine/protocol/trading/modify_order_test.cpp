...
TEST(SerDeTest, ModifyOrderRequest)
{
        ...
        const ModifyOrderRequest expected_request = {expected_symbol, expected_order_id, expected_quantity};
...
TEST(SerDeTest, ModifyOrderResponse)
{
        ...
        const ModifyOrderResponse expected_response = {expected_symbol, expected_order_id, expected_quantity, expected_success};
