...
TEST(SerDeTest, CancelOrderRequest)
{
    ...
    const CancelOrderRequest expected_request = {
        expected_symbol, expected_order_id
    };
...
TEST(SerDeTest, CancelOrderResponse)
{
    ...
    const CancelOrderResponse expected_response = {
        expected_symbol, expected_order_id, expected_success
    };
