...
TEST(SerDeTest, AddOrderRequest)
{
    ...
    const AddOrderRequest expected_request = {
        expected_symbol, expected_price, expected_quantity, expected_side
    };
...
TEST(SerDeTest, AddOrderResponse)
{
    ...
    const AddOrderResponse expected_response = {
        expected_symbol,   expected_order_id, expected_price,
        expected_quantity, expected_side,     expected_timestamp
    };
