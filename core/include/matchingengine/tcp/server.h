...
namespace tcp
{
        ...
        {
        public:
                Server(core::RingBuffer<core::Payload> &inbound_buffer,
                       core::RingBuffer<core::Payload> &outbound_buffer, boost::asio::io_context &io_context);

                Server(const unsigned short &port, core::RingBuffer<core::Payload> &inbound_buffer,
                       core::RingBuffer<core::Payload> &outbound_buffer, boost::asio::io_context &io_context);
        ...
        private:
                ...
                boost::bimap<core::ConnectionId, std::string> f_active_connections{};
                std::unordered_map<core::ConnectionId, std::shared_ptr<Connection>> f_connections_by_id{};
