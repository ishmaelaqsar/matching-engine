...
static auto get_book_request(const std::string_view line) -> core::protocol::view::GetBookRequest
{
...
static auto add_order_request(const std::string_view line) -> core::protocol::trading::AddOrderRequest
{
        std::istringstream iss{std::string(line)};
        std::string symbol;
...
static auto modify_order_request(const std::string_view line) -> core::protocol::trading::ModifyOrderRequest
{
        std::istringstream iss{std::string(line)};
        std::string symbol;
...
static auto cancel_order_request(const std::string_view line) -> core::protocol::trading::CancelOrderRequest
{
        std::istringstream iss{std::string(line)};
        std::string symbol;
...
static auto parse_line(const std::string_view line) -> AnyRequest
{
        ...
        if (type == "get") return get_book_request(rest);
        if (type == "add") return add_order_request(rest);
        if (type == "modify") return modify_order_request(rest);
        if (type == "cancel") return cancel_order_request(rest);
