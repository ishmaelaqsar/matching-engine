...
auto parse_args(const int argc, char **argv) -> std::unordered_map<std::string, std::string>
{
...
int main(const int argc, char **argv)
{
        ...
        client->register_handler<core::protocol::trading::AddOrderResponse>(
                response_handler<core::protocol::trading::AddOrderResponse>);
        client->register_handler<core::protocol::trading::ModifyOrderResponse>(
                response_handler<core::protocol::trading::ModifyOrderResponse>);
        client->register_handler<core::protocol::trading::CancelOrderResponse>(
                response_handler<core::protocol::trading::CancelOrderResponse>);
        client->register_handler<core::protocol::trading::Trade>(response_handler<core::protocol::trading::Trade>);
        client->register_handler<core::protocol::view::GetBookResponse>(
                response_handler<core::protocol::view::GetBookResponse>);
